package com.istarindia.visd.cardauto.cards.GameOverCard;
 ...
 */
public class IstarGameOverCard extends CardView implements IstarGameCard {
    ...
    public IstarGameOverCard(Context context) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.theView = inflater.inflate(R.layout.game_over_card, null);
