package com.istarindia.visd.cardauto.cards.MultipleOptionSingleChoiceCard;
 ...
 */
public class MultipleOptionSingleChoiceCardIstar extends CardView implements IstarGameCard {
    ...
    public MultipleOptionSingleChoiceCardIstar(Context context) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.theView = inflater.inflate(R.layout.multiple_option_single_choice_card, null);
